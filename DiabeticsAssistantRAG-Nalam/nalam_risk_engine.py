...
class RiskAnalyzer:
    ...
    def bp_risk(user: UserProfile):
        ...
        if sys >= 140 or dia >= 90: return "STAGE2"
        elif sys >= 130 or dia >= 80: return "STAGE1"
    ...
    def kidney_risk(user: UserProfile):
        ...
        elif 60 <= egfr < 90: return "MILD_IMPAIRMENT"
        elif 30 <= egfr < 60: return "MODERATE_IMPAIRMENT"
    ...
    def analyze(user: UserProfile):
        """Runs all checks and returns a dictionary of flags."""
        return {
